...
<head>
  ...
  $sql = "SELECT invoices.invoice_no, customers.name, invoice_details.sub_total as sub_total,invoice_details.qty,invoice_details.unit_price,invoice_details.srno, invoices.nett,invoices.paid,invoices.vat, invoices.due,invoices.gross,customers.address1,customers.address2,customers.city,customers.post_code,customers.mobile,customers.email,skips.size FROM invoices
                    ...
                    <div class="panel-body invoice">
                        ...
                        <table class="table table-invoice" >
                           ...
                           <?php 
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo "£".$invoice1['sub_total'];?></td>
                            </tr>
                              <?php 
                               }
                           ?>
                       ...
                       <table class="table table-invoice" >
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo "£".$invoice['gross'];?></td>
                        ...
                        <div class="text-center invoice-btn">
                            ...
                            <a href="invoice_print.php?invoice_no=<?php echo $invoice_number;?>" target="_blank" class="btn btn-primary btn-lg"><i class="fa fa-print"></i> Print Invoice </a>
