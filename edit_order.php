...
<div id="new_customer" class="col-md-8">
                      ...
                      <legend class="well-legend"><span class="glyphicon glyphicon-th-list">  </span>&nbsp;Customer Details</legend>
                         ...
                         <div class="form-group">
                                 ...
                                 <input required type="text" name="customer_name" id="customer_name" class="form-control" placeholder="Customer Name" autocomplete="off" value="<?php echo $row['name'];?>" />
                                 <input  type="text" name="customer_id" value="<?php echo $row['customer_id'];?>" id="customer_id" placeholder="xxx" />
                  ...
                  <div class="input-group">
                    <input type="text" id="post_code" name="post_code" placeholder="Enter Post Code" class="form-control"  tabindex="5" value="<?php echo $row['post_code'];?>">
                 ...
                 <label for="phone">Phone</label>
                  <div class="input-group">
                    <input type="text" id="phone" name="phone" placeholder="Enter Phone Number" class="form-control"  tabindex="3" value="<?php echo $row['mobile'];?>">
                   ...
                   <label for="city">Area/Town</label>
                       <div class="input-group">
                         <input name="city" type="text" id="city" placeholder="Enter City" class="form-control"  tabindex="6" value="<?php echo $row['city'];?>">
              ...
              <label for="address1">Address </label>
                      <input required autocomplete="off" type="text" id="customer_address" name="customer_address" class="form-control" value="<?php echo $row['address1'];?>">
                                 <input  type="text" name="address_id" id="address_id" placeholder="xxx" value="<?php echo $row['address_id'];?>" />
              ...
              <label for="address1">Site Details </label>
                         ...
                         <input name="site" type="text" id="site" placeholder="Enter Details" class="form-control"  tabindex="4" value="<?php echo $row['site'];?>">
 ...
 <input type="text" style="width:70%;" value="<?php echo $start_date;?>" name="start_date" class="form-control" placeholder="Select a Date" name="start_date" id="start_date"  tabindex="7" >
                      ...
                      <label for="jobtype">Job Type</label>
                        ...
                        <select name="job_type" style="width:70%;" id="job_type" class="form-control">
                            <option value="1" <?php if ($row['job_type'] == 1) { echo 'selected'; } ?>>Delivery</option>
                            <option id="Collection" value="2" <?php if ($row['job_type'] == 'Collection') { echo 'selected'; } ?>>Collection</option>
                            <option id="Exchange" value="3" <?php if ($row['job_type'] == 'Exchange') { echo 'selected'; } ?>>Exchange</option>
                          </select>
                        </div>
          ...
          ?>
                      ...
                      <label for="amount">Price Given</label>
                             <div id="gross_payment" class="form-group">
                                <input type="text" style="width:30%; height:40px;" name="amount" id="amount" class="form-control numeric" tabindex="11" value="<?php echo $row['amount'];?>">                                    
                                <div style="color:red;" id="errmsg"></div>
                           </div>
                        <div id="order_created"></div> 
                      <label for="nos">Skips</label>
                             <div class="form-group">
                              <input id="skips" style="width:20%;height:40px;" type="text" value="1" name="skips"class="form-control numeric" readonly>
                              <div id="errmsg"></div>
                              </div>
  ...
  <option style="padding:10px; background-color:#2977C9; color:#F9F0F1; cursor:pointer;" value="<?php echo $skip['id']; ?>" <?php if ($row['size'] == $skip['size']) { echo 'selected'; } ?>>
     <?php echo $skip['size']; ?>
    </option>
            <?php
  ...
  <option style="padding:10px; background-color:#2977C9; color:#F9F0F1; cursor:pointer;" value="<?php echo $skip_location['id']; ?>" <?php if ($row['skip_location'] == $skip_location['name']) { echo 'selected'; } ?>>
            ...
            ?>
                       ...
                       <div class="form-group">
                          <select id="delivery_slot" name="delivery_slot" style="width:70%;" class="form-control">
                            <option value="AM" <?php if ($row['delivery_slot'] == 'AM') { echo 'selected'; } ?>>AM</option>
                            <option value="PM" <?php if ($row['delivery_slot'] == 'PM') { echo 'selected'; } ?>>PM</option>
                          </select>
                        </div>
                         <label for="nos">Job Paid</label>
                               <div class="form-group co-md-1">
                               <select style="height:40px;" name="payment_type" id="payment_type"  class="form-control" style="font-size:13px; cursor:pointer;">
  ...
  <option style="padding:10px; background-color:#2977C9; color:#F9F0F1; cursor:pointer;" value="<?php echo $payment['id']; ?>" <?php if ($row['payment_type'] == $payment['name']) { echo 'selected'; } ?>>
     <?php echo $payment['name']; ?>
            ...
            ?>
                   ...
                   <div class="col-md-10"><input type="submit" style="cursor: pointer; font-family:Montserrat;height: 40px;border-radius: 0px;"  class="btn btn-success btn-large pull-right" value="Save Job"></div>
                  </div>
              </div>
              <div class="col-md-2"></div>
      </div>  
