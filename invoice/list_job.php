...
WHERE order_details.start_date='$today' order by order_details.start_date DESC";
...
echo '<p style="text-align:center;background-color:light gray; color:#000000; padding:15px; font-size:18px;">Total '.$rowcount.' jobs are starting today ('.$today.'). You can see other jobs by applying filter. </p>';
?>
...

{
	echo "This job is not done";
			  ...
			  ?>
               ...
               <?php
                           if($job['payment_type']!='Fully Paid'){?>
               ...
               <td bgcolor="#13ED47"><?php echo $job['payment_type'];?></td>  
              <?php }else{?><td><?php echo $job['payment_type'];?></td><?php }?>
				...
				{?>
					...
					<?php  }?>
                         ...
                         <?php if($job['tip_status']=="Tipping Done"){?><td bgcolor="#13ED47" col-id="12"  data-id="<?php echo $job['order_id'];?>"><?php echo $job['tip_status'];?></td><?php }else{?>
     <td col-id="12"  data-id="<?php echo $job['order_id'];?>">Not Done</td> <?php }?>
       
     <?php if($job['status']=="Job Done"){?><td bgcolor="#13ED47" col-id="13" data-status="<?php echo $job['status'];?>"  data-id="<?php echo $job['order_id'];?>"><?php echo $job['status'];?></td><?php }else{?>
     <td col-id="13" data-id="<?php echo $job['order_id'];?>">Not Done</td> <?php }?>  
     
                           
                           
    <input id="status" type="hidden" value="<?php echo $job['status'];?>"/>
    <td><a href="#"><i class="glyphicon glyphicon-check"></i></a></td>                       
                           <td>
