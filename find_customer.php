...
?>
<li style="cursor: pointer; width:250px;font-family:Montserrat; font-size:12px; font-weight:bold; color:#FBF2F2; padding:10px; background-color:#05629E;" onClick="selectCustomer('<?php echo $customer["id"].'-'.$customer["name"]; ?>');"><?php echo $customer["name"]." - ".$customer["post_code"]; ?></li>
