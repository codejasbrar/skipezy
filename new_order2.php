                ...
                <div class="col-md-8">
                 <div class="panel" style="background-color: #e9e9e9;box-shadow: 5px 5px 5px;">
                    <div class="panel-primary">
                     <div class="panel-heading"><center>Customer and Delivery Details</center></div>
                     </div>
                     <div class="panel-body">
                     <div class="frmSearch">
<input type="text" id="search-name" placeholder="Customer Name" />
<input type="text" name="old_customer_id" id="old_customer_id" placeholder="xxx" />
...
<div id="new_customer">
               ...
               <label for="phone">Phone</label>
                  <div class="form-group">
                    <input type="text" id="phone" name="phone" placeholder="Enter Phone Number" class="form-control">
                     ...
                     <br>
                            <label for="jobtype">Select a Address</label>
                        <div class="col-md-12" id="address">
                           ...
                           <div class="form-group col-md-8">
                            <label for="jobtype">Adddress Details</label>
                           <div id="delivery_address1"></div>
                           <div id="new_delivery_address11">
                              <div class="col-md-12">
                                 
                                 <div class="col-md-6">
                                    <label>&ensp;</label>
                           <input type="text" placeholder="Enter Address" name="del_address" id="name" class="form-control"></div>
                           <div class="col-md-6">
                              <label>&ensp;</label>
                           <input type="text" placeholder="Enter Post Code" name="del_post_code" id="name" class="form-control"></div></div>
                           <div class="col-md-12">
                                 <div class="col-md-6">
                                    <label>&ensp;</label>
                           <input type="text" placeholder="City" name="del_city" class="form-control"></div>
                           <div class="col-md-6">
                              <label>&ensp;</label>
                           <input type="text" id="name" class="form-control"></div></div>
                           <div class="col-md-12">
                           &ensp;
                           <center><input type="button" id="name" class="btn btn-primary" value="Save"></center>
                           </div>
                           </div>
             ...
             <div class="col-md-8">
                <div class="panel">
                   <div class="panel-primary" style="box-shadow: 5px 5px 5px;">
                     <div class="panel-heading"><center>Enter Job Detail</center></div>
                   </div>
 ...
 <input type="text" style="width:70%;" value="<?php echo date('Y-m-d');?>" name="start_date" class="form-control" placeholder="Select a Date" name="start_date" id="start_date">
                      </div>
                     ...
                     <div id="exchange_with">
                        ...
                        <div class="form-group">
                           <select name="exchange_skip_type" style="width:70%;" id="exchange_skip_id" class="form-control">
                  ...
                  <div class="panel-primary">
                     <div class="panel-heading"><center>Payment Details</center></div>
                      ...
                      <div id="order_created"></div> 
                            <div class="col-md-1"></div>
                            <div class="col-md-5">
                              <label for="amount" class="col-sm-4">Price Given</label>
                             <div id="gross_payment" class="form-group col-sm-8">
                                <input type="text" style="width:50%; height:30px;" name="amount" id="amount" value="0.00" class="form-control numeric">                                    <div style="color:red;" id="errmsg"></div>
                           </div>
                          
                             </div>
                           <div class="col-md-5">
                               <label for="nos" class="col-sm-7">No.of Skips</label>
                             <div class="form-group col-sm-5" style="margin-left:-10%;">
                              <input id="skips" style="width:50%;height:30px;" type="text" value="1" name="skips"class="form-control numeric" readonly>
                              <div id="errmsg"></div>
                              </div>
                              <label for="nos" class="col-sm-7">Job Paid</label>
                               <div class="form-group col-sm-5" style="margin-left: -10%;">
                               <select style="height:30px" name="payment_type" id="payment_type"  class="form-control" style="font-size:13px; cursor:pointer;">
                                <option style="padding:10px; background-color:#2977C9; color:#F9F0F1; cursor:pointer;"value="0" selected>Please Select</option>
  ...
  <option style="padding:10px; background-color:#2977C9; color:#F9F0F1; cursor:pointer;" value="<?php echo $payment['id']; ?>">
     <?php echo $payment['name']; ?>
            ...
            ?>
                              ...
                              <input type="submit" style="cursor: pointer; font-family:Montserrat; font-size:18px; font-weight:bold; color:#FBF2F2; padding:15px; background-color:#46A818;"  class="btn-sm pull-right" >Save Job</p>
                              </div>
