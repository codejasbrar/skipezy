...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&key=AIzaSyBwX3RE7ZMn6mrmuV87j6bsORZqxPhAwHM"></script>
...
<div id="new_customer" class="col-md-8">
 ...
 <input type="text"  value="<?php echo $start_date;?>" name="start_date" class="form-control" placeholder="Select a Date" name="start_date" id="start_date"  tabindex="7" >
                      </div>
                        ...
                        <div class="form-group col-md-6">
						 <label for="skiptype">Exchange With</label>
                           <select name="exchange_skip_id" style="background-color:#F30007; color:#ffffff;" id="exchange_skip_id" class="form-control">
                               <?php
     ...
     <?php echo $skip['size']; ?>
        ...
        die('skip 3 ORDER_Details -Error: ' . mysqli_error($con));
          ...
          ?>
                             ...
                             <div id="gross_payment" class="form-group col-md-6">
							   <label for="amount">Price</label>
                                <input type="text" style="height:40px;" name="amount" id="amount" value="0.00" class="form-control numeric" tabindex="11">                                    <div style="color:red;" id="errmsg"></div>
                           </div>
                        ...
                        <div id="order_created"></div> 
                             ...
                             <div class="form-group col-md-6">
                              ...
                              <input id="skips" style="height:40px;" type="text" value="1" name="skips"class="form-control numeric" readonly>
                              <div id="errmsg"></div>
                              </div>
                   ...
                   <div class="col-md-7 collection">
                        ...
                        <div class="form-group col-md-6">
						  <label for="skiptype" class="collection">Skip Size</label>
                           <select name="skip_id" style="background-color:#053DD4; color:#ffffff;" id="skip_id" class="form-control">
                               <?php
            ...
            ?>
                       ...
                       <div class="form-group col-md-6">
					     <label for="location">Location</label>
                          <select name="skip_location" style="background-color:#053DD4; color:#ffffff;" id="skip_location" class="form-control">
                               <?php
					     ...
					     <label for="delivery_slot">Delivery Slot</label>
                          <select id="delivery_slot" name="delivery_slot" class="form-control">
                            ...
                            <option value="PM">PM</option>
                               ...
                               <select  name="payment_type" id="payment_type"  class="form-control" style="font-size:13px; cursor:pointer;">
     ...
     <?php echo $payment['name']; ?>
			...
			<div class="col-md-5" style="padding:0px;">
				 ...
				 <div class="form-group2" >
				  ...
				  <label class="radio-inline"><input type="radio" onclick="permit_fun('1')" name="permit"  value="yes" >Yes</label>
<label class="radio-inline"><input type="radio" name="permit" onclick="permit_fun('2')" checked value="no">No</label>
				</div>
				...
				<div class="col-md-7" id="permit_section" style="display:none;">
					...
					<div class="form-group col-md-4" >
					  ...
					  <input type="text" class="form-control permit_start_date" name="permit_start_date" id="usr">
					</div>
					
					<div class="form-group col-md-4" >
					  <label for="usr">End date</label>
					  <input type="text" class="form-control permit_end_date" name="permit_end_date" id="permit_end_date">
					</div>
					
					<div class="form-group col-md-4">
					  <label for="usr">Amount</label>
					  <input type="text" class="form-control" value="0" name="permit_amount" id="usr">
					</div>
  ...
  <script>
				...
				$("#post_code").keyup(function(){
					...
					if(search_code == "") { 
					    	...
					    	$.post('https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyBwX3RE7ZMn6mrmuV87j6bsORZqxPhAwHM&address='+ search_code +'&sensor=false', function(r) {
					var lat = r['results'][0]['geometry']['location']['lat'];
					var lng = r['results'][0]['geometry']['location']['lng'];
					$('#lat').val(lat);
					$('#lng').val(lng);
					$.post('https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyBwX3RE7ZMn6mrmuV87j6bsORZqxPhAwHM&latlng='+lat+','+lng+'&sensor=false', function(address) {
							
						$('#customer_address').val(address['results'][0]['address_components'][1]['long_name']);
