...
<input type="text" id="search-name" class="form-control" placeholder="Customer Name" tabindex="1" onblur="checkTextField(this);" autocomplete="off" onkeyup="checkTextField(this);" />
...
<div id="new_customer" class="col-md-12">
                        ...
                        <div class="input-group">
                          <input type="text" id="full_name" name="full_name" placeholder="Enter Full Name" class="form-control"  tabindex="2" >
                  ...
                  <div class="input-group">
                    <input type="text" id="customer_post_code" name="post_code" placeholder="Enter Post Code" class="form-control"  tabindex="5" >
                    <span class="input-group-btn">
                  <span class="btn btn-default pull-right"> 
               ...
               <label for="phone">Phone</label>
                  <div class="input-group">
                    <input type="text" id="phone" name="phone" placeholder="Enter Phone Number" class="form-control"  tabindex="3" >
                    <span class="input-group-btn">
                  <span class="btn btn-default pull-right"> 
                   ...
                   <label for="city">Town</label>
                       <div class="input-group">
                         <input name="city" type="text" id="customer_city" placeholder="Enter City" class="form-control"  tabindex="6" >
                          <span class="input-group-btn">
                  <span class="btn btn-default pull-right"> 
                    <i class="glyphicon glyphicon-map-marker"></i>
                  </span>  
    ...
    <div class="col-md-4">
              ...
              <label for="address1">Address </label>
                       <div class="input-group">
                         <input name="address1" type="text" id="customer_address1" placeholder="Enter Address" class="form-control"  tabindex="4" >
                         <span class="input-group-btn">
                  <span class="btn btn-default pull-right"> 
                    <i class="glyphicon glyphicon-map-marker"></i>
                  </span>  
           ...
           <div class="col-md-2"></div>
                  ...
                  <div class="panel" style="background-color: #e9e9e9;box-shadow: 5px 5px 5px 5px;">
                    <div class="panel-success">
                     <div class="panel-heading" style="background-color:#05629E;"><center>New Delivery Adddress Details</center></div>
                     </div>
                     <div class="panel-body">
     ...
     <?php echo $skip['size']; ?>
            ...
            ?>
                ...
                <label for="location">Location</label>
                       <div class="form-group">
                          <select id="skip_location" name="skip_location" style="width:70%;" class="form-control"  tabindex="10" >
