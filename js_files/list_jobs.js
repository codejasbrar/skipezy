...
$('body').delegate('.post_code,.name,.driver_id,.paid,.from,.to,.job_id','keyup',function()  
{
  ...
  if (search.length > 0) {
   ...
   var dataString ='filter_search=' + filter_search+'&from=' + from+'&post_code=' + post_code+'&name=' + name+'&driver_id=' + driver_id+'&paid=' + paid +'&to=' + to+ '&job_id=' + job_id;
