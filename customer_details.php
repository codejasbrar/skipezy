                              ...
                              <div class="modal-body">
                                 <form id="new_address" method="post">
                                    <div class="form-group">
                                       ...
                                       <input type="text" id="insert_address" placeholder="Enter Address" class="form-control" />
                                    </div>

                                    <div class="form-group">
                                       <label for="last_name">City</label>
                                       <input type="text" id="insert_city" placeholder="Enter City" class="form-control" />
                                    </div>

                                    <div class="form-group">
                                       <label for="email">Post Code</label>
                                       <input type="text" id="insert_post_code" placeholder="Enter Post Code" class="form-control" />
                                    </div>
                     ...
                     <div class="container-fluid col-md-8">
                        ...
                        <div class="panel">
                           ...
                           <div class="panel-primary"style="box-shadow: 5px 5px 5px;">
                              <div class="panel-heading"><center>Payments Made</center></div>
                           </div>
                     ...
                     <div class="panel">
                        <div class="panel-body" style="background-color:#e9e9e9;">
                           ...
                           <div class="form-group col-md-3 pull-right">
                              <p style="padding:15px; margin-top:10px; font-size:16px;" name="create_invoice" class="btn btn-success btn-sm" id="create_invoice">Search Transactions</p>
