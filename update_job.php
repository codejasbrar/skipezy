...
print_r($_POST);
    ...
    <div class="modal-footer">
        ...
        <div id="confirm_button">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <input type="submit" name="allocate_job" id="btn_update" class="btn btn-primary"
...
*/ 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color:black; background-color:#36EB34; padding:20px; font-size:20px; font-weight:bold;">
                        Job Status Updated Successfully.</p>
                </div>
                <div class="modal-footer">
    ...
    $('#btn_update').click(function() {
        ...
        var dataString = 'selected_payment_status=' + selected_payment_status + '&id=' + id + '&job_status=' +
            job_status + '&end_date=' + end_date + '&total=' + total + '&job_paid=' + job_paid + '&driver_id=' +
            driver_id;
        //alert(dataString);
        //return false;
        var td_id = $('#td_id').val();
