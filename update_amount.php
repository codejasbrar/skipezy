    ...
    <div class="modal-content">
     ...
     <input type="hidden" id="order_id" value="<?php echo $order_id;?>">
                        ...
                        <tbody>
                        	...
                        	<tr>
                            <td>Amount</td>
                            <td><input type="text" id="amount" name="amount" value="<?php echo $amount['amount'];?>">
                            </td>
                            </tr>
        ...
        <input type="submit" name="allocate_job" id="modal_button" class="btn btn-primary" value="Update Amount"/>
 ...
 <!-- Now allocate job to selected driver -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="color:black; background-color:#36EB34; padding:20px; font-size:20px; font-weight:bold;"> Amount Updated Successfully.</p>
      </div>
      <div class="modal-footer">
